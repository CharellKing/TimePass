...
void Read() {
  ...
  printf("read:\n");
  TimePass::ShmHashmap<MonthName, int>::Iterator iter = months.Begin();
  ...
  printf("constread:\n");
  TimePass::ShmHashmap<MonthName, int>::ConstIterator citer =
      (TimePass::ShmHashmap<MonthName, int>::ConstIterator)(months.Begin());
...
void Find() {
  ...
  TimePass::ShmHashmap<MonthName, int>::MAP_DATA* p_data =
