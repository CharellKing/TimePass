...
const off_t buff_capacity = 5;

const char* prefix_name = "my_produce_consume_";
...
bool Create() {
    ...
    if (false == pro_con.Create(buff_amount, buff_capacity, cond_param)) {
