...
#ifndef _SHM_SHM_LIST_H

#define _SHM_SHM_LIST_H
...
class ShmList{
 public:
    ...
    bool Create(off_t capacity) {
        ...
        p_ext_ = static_cast<EXTEND*>(p_tmp);
    ...
    const ListNode<T>* Insert(off_t index, const T& data) {
        return CommonList<T, EXTEND>::
                Insert(name_, p_addr_, p_head_, data, index);
    }
